...
changelog:
  - date: 2026-02-01
    change: "Migrated from research/cli.md and added YAML front matter."
---
...
- Stage: Implemented.
- CLI ships JVM + JS binaries; CI runs Branchline JUnit summaries with shared IO; docs cover usage.
- Next: follow-ups in this doc (distribution, npm packaging, CI migration) if desired.
