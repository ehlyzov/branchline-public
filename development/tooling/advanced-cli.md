...
changelog:
  - date: 2026-02-01
    change: "Migrated from research/advcli.md and added YAML front matter."
---
...
- Stage: Proposed.
- Scope captured: shared writes + shared store wiring + CLI flags/stdlib additions + CI migration.
- Next: implement shared write syntax and SharedStore plumbing, then update CLI/stdlib/tests/docs and migrate CI scripts.
