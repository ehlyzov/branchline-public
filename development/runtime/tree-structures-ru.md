...
blocks: []
supersedes: []
superseded_by: ['runtime/tree-structures']
last_updated: 2026-02-01
changelog:
  - date: 2026-02-01
    change: "Migrated from research/structures.md; superseded by runtime/tree-structures (English translation)."
  - date: 2026-02-01
    change: "Marked superseded and linked the English translation."
---
# Структуры данных для деревьев


## Статус (на 2026-01-31)
- Стадия: заменено английской версией (superseded).
- Реализация: рантайм по-прежнему использует `LinkedHashMap`/`List`; аренные структуры ещё не внедрены.
- Далее: выбрать горячие пути и прототипировать массивные (аренные) структуры.

> Этот документ сохранён для истории и заменён английской версией: `development/runtime/tree-structures.md`.
