...
depends_on: []
blocks: []
supersedes: ['ai/mcp-module-superseded']
superseded_by: []
last_updated: 2026-02-01
changelog:
  - date: 2026-02-01
    change: "Migrated from research/ai.md and added YAML front matter."
  - date: 2026-02-01
    change: "Linked superseded MCP document in metadata."
---
# Task: Branchline LLM Interaction Pipelines (Planitforme-inspired)


## Status (as of 2026-01-31)
- Stage: Proposal / discovery.
- Decisions recorded for pipeline YAML, execution model, UI, providers, and trace policy.
- Next: define an MVP schema and runtime module boundaries (core runtime, MCP, REST, UI) and pick the first vertical slice.
