...
- Stage: In progress.
- Steps 1-5 and 7-9 are done; step 6 (semantic output validation) and full-suite mapping remain open.
- Next: implement normalized output comparison and complete the YAML case mappings.
